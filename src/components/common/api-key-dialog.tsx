...
export function ApiKeyDialog({ open, onOpenChange, onApiKeySaved }: ApiKeyDialogProps) {
  ...
  const handleSave = () => {
    ...
    try {
      ...
      console.error('Unable to save the API key (browser storage blocked).', err)
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Please enter the API key required to connect to the Eliza server. This key will be stored locally in your
            browser.
          </DialogDescription>
        </DialogHeader>
